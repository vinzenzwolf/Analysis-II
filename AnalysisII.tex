...
\begin{enumerate}
  ...
  \item Spherical coordinates: \[ a \le x^2,y^2,z^2 \le b\] \[\gamma(r, \theta, \varphi) = (r\sin(\varphi)\cos(\theta), r \sin(\varphi)\sin(\theta), r \cos(\varphi))\] with \(\mathop{dx}\mathop{dy}\mathop{dz} = \int_{\sqrt{a}}^{\sqrt{b}}\int_{o}^{\pi}  r^2 \sin(\varphi) \mathop{dr} \mathop{d\theta} \mathop{d\varphi}\)
\end{enumerate}
